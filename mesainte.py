...
def interpolate4p(x,y_11,y_12,x_11,x_12,y_21,y_22,x_21,x_22,y_31,y_32,x_31,x_32,y_41,y_42,x_41,x_42,z,z_1,z_2,z_3,z_4):
    ...
    #y = y_1 + (y_2+y_4 - y_1)*(z-z_1)/(z_2+z_4-z_1) +( y_3 + (y_2+y_4 - y_3)*(z-z_3)/(z_2+z_4-z_3))
    #y = (y_1+y_3)+ (y_2+y_4 - y_1-y_3)*(z-z_1)/(z_2-z_1)*(z-z_3)/(z_4-z_3)#+ (y_4 - y_1)*(z-z_1)/(z_4-z_1) +( y_3 + (y_2 - y_3)*(z-z_3)/(z_2-z_3) + (y_4 - y_3)*(z-z_3)/(z_4-z_3))
    return y
...
if __name__ == '__main__':
    ...
    #plot_Hr(dict_2,dict_4,0.2,0.4,0.3,dict_3,test_3.eeps)
    #plot_Hr(dict_3,dict_5,0.3,0.5,0.4,dict_4,test_4.eeps)
    ...
    #plot_Hr(dict_7,dict_9,0.7,0.9,0.8,dict_8,test_8.eeps)
    #plot_Hr(dict_8,dict_10,0.8,1,0.9,dict_9,test_9.eeps)
    #plot_Hr(dict_9,dict_11,0.9,1.1,1,dict_10,test_10.eeps)
    #close()

    # In progress
    
    #T,x = int_data4p(dict_6,dict_8,dict_9,dict_5,0,0.6,0.8,0.7,0.9,0.5,len(dict_7))
    #L,x = int_data4p(dict_6,dict_8,dict_9,dict_5,1,0.6,0.8,0.7,0.9,0.5,len(dict_7))
